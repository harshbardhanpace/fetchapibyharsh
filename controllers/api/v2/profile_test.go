...
func TestGetProfile(t *testing.T) {
	...
	ctx.Request = httptest.NewRequest(http.MethodGet, "/api/space/v2/user/profile/getProfile", nil)
	...
	ctx.Request = httptest.NewRequest(http.MethodGet, "/api/space/v2/user/profile/getProfile?clientId=HI009", nil)
	...
	//Init order provider
	InitProfileProviderV2(profileMock{})
